...
-- Migration 002
-- Note: CONCURRENTLY removed — not supported in Supabase SQL Editor
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_readings_facility_ts_source
    ON readings (facility_id, timestamp DESC, source);

-- ALERTS: alert history + unacknowledged alerts
CREATE INDEX IF NOT EXISTS idx_alerts_facility_created
...
CREATE INDEX IF NOT EXISTS idx_audit_facility_created
...
CREATE INDEX IF NOT EXISTS idx_commands_facility_created
...
CREATE INDEX IF NOT EXISTS idx_commands_expired
